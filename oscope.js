...
var d3 = require("d3"),
    oscope = require("../oscope.v1").oscope;

util.puts(JSON.stringify({
  "name": "oscope",
  "version": oscope.version,
  "description": "A JavaScript library for oscilloscope-like time series visualization.",
  "keywords": ["time series", "visualization", "d3"],
  "homepage": "http://odrisci.github.io/oscope",
  "author": {"name": "Cillian O'Driscoll"}, 
  "repository": {"type": "git", "url": "http://github.com/odrisci/oscope.git"},
  "main": "./index.js",
  "dependencies": {
    "d3": "3.x"
  },
